...
<head>
    ...
    <script src="/Public/dist/js/jquery-3.1.0.min.js" type="javascript"></script>
    <script src="/Public/dist/js/bootstrap.min.js" type="javascript"></script>
</head>
...
<div class="container-fluid">
    <div class="col-lg-8 col-lg-offset-2">
        <table class="table table-bordered">
            ...
            <tr>
                <th>1</th>
                <td rowspan="2" bgcolor="#faebd7">软件工程概论</td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
            ...
            <form role="form" class="form-inline" action="<?php echo U('index');?>" method="post">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="1" name="oddWeek">单周</label></div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="1" name="evenWeek">双周</label></div>
                    </div>
                    <div class="col-xs-6">
                    ...
                    <div class="row">
                        <div class="col-xs-3 col-xs-offset-8">
                            <div class="col-xs-6">
                                <button type="submit" class="btn btn-primary" style="margin-left: 5%" name="submit">点击查询</button></div>
                        </div>
                    </div>
                </div>
            </form>
